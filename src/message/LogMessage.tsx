...
export const LogMessage = (message: ILogMessageRecord) => {
    return (
        <div
            ...
            {message.level == 'debug' && <button className="border-solid rounded bg-violet-500 w-14 flex justify-center text-xs text-slate-200 font-apple-system">debug</button>}
